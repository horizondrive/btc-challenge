...
```math
text{Effective search space} = \frac{2^{160}}{28 \times 10^6} \approx 5.2 \times 10^{41}.
```
...
Yeah, I can hear you saying "but these are the probabilities of generating one bitcoin addresses, programs can generate them many at the same time!". Here's the thing: no.
